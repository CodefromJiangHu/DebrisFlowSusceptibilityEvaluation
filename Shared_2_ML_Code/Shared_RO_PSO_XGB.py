...
if __name__ == '__main__':
    ...
    flag_PSO = False
    n_splits = 10
    n_estimators_optimal, max_depth_optimal, lr_optimal = 569, 126, 0.9957245108119622
    ...
    if flag_PSO:
        ...
        n_estimators_optimal, max_depth_optimal, lr_optimal = int(pso.gbest_x[0]), int(pso.gbest_x[1]), pso.gbest_x[2]
